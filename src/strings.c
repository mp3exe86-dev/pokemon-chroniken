...
const u8 gText_Boulderbadge[] = _("STEINRUNE");
const u8 gText_Cascadebadge[] = _("FLUSSRUNE");
const u8 gText_Thunderbadge[] = _("STURMRUNE");
const u8 gText_Rainbowbadge[] = _("FARBRUNE");
const u8 gText_Soulbadge[] = _("SEELENRUNE");
const u8 gText_Marshbadge[] = _("NEBELRUNE");
const u8 gText_Volcanobadge[] = _("GLUTRUNE");
const u8 gText_Earthbadge[] = _("URRUNE");
...
const u8 gText_Vermilion[] = _("MORLOND");
...
const u8 gText_RegionMap_AreaDesc_VictoryRoad[] = _("A tunnel situated on GRENZPFAD II.\nIt earned its name because it\nmust be traveled by all TRAINERS\naiming for the top.");
...
const u8 gText_RegionMap_AreaDesc_SafariZone[] = _("An amusement park outside DORNVAEL\nwhere many rare POKéMON can\nbe observed in the wild.\nCatch them in a popular game!");
