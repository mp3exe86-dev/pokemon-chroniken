...
#define FLAG_HIDE_ROUTE21_NORTH_ITEM_ABSOL                      0x1FF
#define FLAG_HIDE_ROUTE21_NORTH_SCIENTIST                       0x200
...
#define FLAG_ARCHIVAR_CERULEAN_DEFEATED   FLAG_0x8F2
#define FLAG_ARCHIVAR_CERULEAN_ITEM_GIVEN FLAG_0x8F1
